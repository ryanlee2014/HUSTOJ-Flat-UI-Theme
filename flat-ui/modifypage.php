...
<tr><td>找回密码问题:
<td><input name="confirmquestion" size=30 type=text value="<?php echo htmlentities($row->confirmquestion,ENT_QUOTES,"UTF-8")?>" >
</tr>
<tr><td>找回密码答案:
<td><input name="confirmanswer" size=30 type=text value="" >
</tr>
<tr><td>
