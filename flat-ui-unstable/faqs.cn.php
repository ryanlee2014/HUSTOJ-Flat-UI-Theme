...
<p><font color=green>Q</font>:这个在线裁判系统使用什么样的编译器和编译选项?<br>
  <font color=red>A</font>:系统运行于<a href="https://www.centos.com">CentOS</a>
	Linux. 使用<a href="http://gcc.gnu.org/">GNU GCC/G++</a> & <a href="https://clang.llvm.org" target="_blank">LLVM Clang/Clang++</a>作为C/C++编译器,
	<a href="http://www.freepascal.org">Free Pascal</a> 作为pascal 编译器 ，用
	<a href="http://openjdk.java.net/">OpenJDK-8</a> 编译 Java. 对应的编译选项如下:<br>
</p>
<table border="1">
  <tr>
    <td>C:</td>
  ...
  <tr>
    <td>Java:</td>
    <td><font color="blue">javac -J-Xms32m Main.java</font>
    <br>
...
<p>  编译器版本为（系统可能升级编译器版本，这里直供参考）:<br>
  <font color=blue>gcc (GCC) 4.8.5 20150623 (Red Hat 4.8.5-11)
</font><br>
