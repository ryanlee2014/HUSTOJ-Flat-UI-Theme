...
<div align='center'>
    ...
    <ul class="pagination">
      <!--  <li class="previous"><a class="fui-arrow-left" href="problemset.php?page=<?php// echo $page-1 ?>"></a></li>-->
<?php
...
?>
<!--<li class="next"><a href="problemset.php?page=<?php //echo $page+1 ?>" class="fui-arrow-right"></a></li>-->
</ul></div></div>
</div><center>
<table>
